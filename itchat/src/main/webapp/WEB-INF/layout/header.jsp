...
<body>
 <div class="jumbotron" style="margin-bottom: 0;">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark" style="margin-bottom: 1em;">
    <a class="navbar-brand d-lg-none btn btn-outline-light" href="#" style="font-size: 1rem;">Log-in</a>
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#open1" aria-controls="navbarTogglerDemo02" aria-expanded="false" aria-label="Toggle navigation">
